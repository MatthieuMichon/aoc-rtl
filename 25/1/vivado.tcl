namespace eval ::textio {
    proc load {file} {
        ...
        while {[gets $fhandle rotation]>0} {
            lappend rotations $rotation
        }
        close $fhandle
        return $rotations
    }
...
proc ::build {arg_dict} {
    ...
    report_utilization -hierarchical -hierarchical_min_primitive_count 0 -file hierarchical_utilization.txt
